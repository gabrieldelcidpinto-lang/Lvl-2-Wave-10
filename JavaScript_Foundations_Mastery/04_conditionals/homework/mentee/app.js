...
const studentName = "Gabriel Del Cid Pinto"; // This will not change
const maxScore = 100; // The max score wont change
const passingScore = 60; // The passing score wont change
let earnedScore = 73; // This may change
let isExtraCredit = false; // This may change
...
//Because JS checks conditions from top to bottom and stops at the first one that is true.
...
if (earnedScore >= passingScore && attendancePercent >= minAttendance){
    ...
    console.log(`Not elegible. Score: ${earnedScore} | Attendance: ${attendancePercent} %`);
}
...
const honorRollTheshold = 90;
const hasDisciplinaryNote = false;

if ( percentage >= honorRollTheshold && !hasDisciplinaryNote) {
