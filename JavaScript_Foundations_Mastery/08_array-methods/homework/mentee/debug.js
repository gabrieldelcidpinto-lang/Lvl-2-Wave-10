...
//There is no return value within .map()
...
//Using "=" instead of "===". One is to assign a value to a variable, the other one is a strict equality operator.
...
//It should be (item.quantity * item.price)

// Bug 2 ↓

//The acc is not set to 0
